...
<div class="content-wrapper school-form-container">
    <div class="container-fluid">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- School Info Banner -->
                <div class="school-info-banner animate-fade-in">
                    <div>
                        <h4 class="mb-1">{{ $school->name }}</h4>
                        <p class="mb-0">School Code: {{ $school->code }}</p>
                    </div>
                    <div class="school-stats">
                        <i class="fas fa-users mr-1" style="font-size: 0.6rem;"></i>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" 
                                          ...
                                          rows="3" 
                                          placeholder="Provide a brief description of the school">{{ old('description', $school->description) }}</textarea>
                                @error('description')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-triangle"></i>
                                        {{ $message }}
                        ...
                        <div class="form-section">
                            ...
                            <div class="status-selector">
                                <div class="status-option">
                                    <input type="radio" name="status" value="active" id="status_active" {{ old('status', $school->status) == 'active' ? 'checked' : '' }}>
                                ...
                                <div class="status-option">
                                    <input type="radio" name="status" value="inactive" id="status_inactive" {{ old('status', $school->status) == 'inactive' ? 'checked' : '' }}>
