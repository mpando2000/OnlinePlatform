...
<div class="content-wrapper form-page">
    <div class="container-fluid form-shell">
        ...
        <div class="form-card">
            <form action="{{ route('updateClass', $school_class->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="field">
                    <label>Class Name</label>
                    <input type="text" name="name" value="{{ old('name', $school_class->name) }}" required>
                </div>
