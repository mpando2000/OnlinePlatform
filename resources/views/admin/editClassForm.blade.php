                ...
                <div class="card form-card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">
                            ...
                            Edit Class: {{ $school_class->name }}
                        </h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('updateClass', $school_class->id) }}" method="POST" id="editClassForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       name="name" 
                                       class="form-control" 
                                       placeholder="Enter class name (e.g., Grade 10A, Form 3 Science)"
                                       value="{{ old('name', $school_class->name) }}"
                                       required>
                                <div class="form-text">
                                    Choose a clear, descriptive name for the class
                                </div>
                            </div>
