...
<div class="content-wrapper form-page">
    <div class="container-fluid form-shell">
        <div class="form-header-panel">
            <div>
                <h1><i class="fas fa-sign-in-alt"></i> Join Session</h1>
                <p>Enter the meeting code to open the online class.</p>
            </div>
        ...
        <div class="form-card">
            <form action="{{ route('admin.joinMeeting') }}" method="POST">
                ...
                <div class="field">
                    ...
                    <input type="text" name="meeting_code" value="{{ old('meeting_code') }}" autocomplete="off" required>
                </div>
                <div class="form-actions">
                    <button type="submit" class="ui-btn ui-btn-primary"><i class="fas fa-video"></i> Join Session</button>
                    <a href="{{ route('admin.onlineSessions') }}" class="ui-btn ui-btn-light"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
.form-shell { max-width: 780px; padding: 18px; }
