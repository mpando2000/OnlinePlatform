...
<div class="content-wrapper form-page">
    <div class="container-fluid form-shell">
        <div class="form-header-panel">
            <div>
                <h1><i class="fas fa-plus-circle"></i> Add Class</h1>
                <p>Create a new academic class.</p>
            </div>
        ...
        <div class="form-card">
            <form action="{{ route('storeClass') }}" method="POST">
                ...
                <div class="field">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Example: Form 1" required>
                </div>
                <div class="form-actions">
                    <button type="submit" class="ui-btn ui-btn-primary"><i class="fas fa-save"></i> Save Class</button>
                    <a href="{{ route('admin.classes') }}" class="ui-btn ui-btn-light"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </form>
        </div>
    </div>
