                ...
                <div class="page-header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.subjects', [$class, $subject]) }}">{{ $subject->name }}</a>
                            </li>
            ...
            <div class="col-md-10 col-lg-8">
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('adminMaterials.store', ['class' => $class->id, 'subject' => $subject->id]) }}" 
                              method="POST" 
                              id="material-form" 
                            ...
                            <div class="mb-4">
                                ...
                                <select name="type" id="type" class="form-select" required>
                                    ...
                                    <option value="document" {{ old('type') == 'document' ? 'selected' : '' }}>
                                        <i class="fas fa-file-pdf"></i> Document (PDF, DOC, etc.)
                                    </option>
                                    <option value="video" {{ old('type') == 'video' ? 'selected' : '' }}>
                                        <i class="fas fa-video"></i> Video (MP4, AVI, etc.)
                                    </option>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                ...
                                <a href="{{ route('admin.subjects', [$class, $subject]) }}" class="btn btn-secondary">
