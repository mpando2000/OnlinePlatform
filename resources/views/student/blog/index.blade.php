        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    ...
                    <p class="text-muted mb-0">Share thoughts and connect with your classmates</p>
                </div>
                ...
                <div class="col-lg-10 col-xl-8">
                    ...
                    <div class="chat-container">
                        ...
                        <div class="chat-header-card">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="chat-info">
                                        <h5 class="mb-0">Class Discussion</h5>
                        ...
                        <div class="chat-input-container">
                            <form id="message-form" class="message-form" action="{{ route('student.blog.store') }}" method="POST">
                                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Routes:', {
        store: '{{ route("student.blog.store") }}',
        index: '{{ route("student.blog") }}'
    });
...
function sendMessage() {
    ...
    fetch('{{ route("student.blog.store") }}', {
        method: 'POST',
        headers: {
...
function refreshMessages() {
    ...
    fetch(`{{ route('student.blog') }}?after=${lastMessageId}`, {
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        }
    })
