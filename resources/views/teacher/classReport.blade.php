    ...
    <div class="container-fluid page-shell">
        <div class="page-panel">
            <div>
                ...
                <p>Review available classes and their basic information.</p>
            </div>
            <div class="page-actions">
                <a href="{{ route('teacher.classPrint') }}" target="_blank" class="ui-btn ui-btn-primary"><i class="fas fa-print"></i> Print</a>
                <a href="{{ route('teacher.report') }}" class="ui-btn ui-btn-soft"><i class="fas fa-arrow-left"></i> Reports</a>
            </div>
        </div>
