...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="print-header">
                    ...
                    <h5><i class="fas fa-users me-2"></i>User Data Report - Teacher View</h5>
                ...
                <div class="print-footer">
                    ...
                    <p><small>This report was generated automatically for teacher access. Admin users are excluded from this view.</small></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        console.log('Teacher print page loaded successfully');
    </script>
</body>
</html>
