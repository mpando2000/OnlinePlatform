            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card password-form-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('teacher.change.password.submit') }}" method="POST" id="change-password-form">
                            @csrf
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <button type="submit" class="btn btn-info btn-lg me-md-2" id="submit-btn">
...
<style>
    ...
    .info-card {
        ...
        background: linear-gradient(135deg, #e5f9fd 0%, #f8f9fa 100%);
    }
