    ...
    <div class="container-fluid page-shell">
        <div class="page-panel">
            <div>
                ...
                <p>Review student and teacher account information.</p>
            </div>
            <div class="page-actions">
                <a href="{{ route('teacher.reportPrint') }}" target="_blank" class="ui-btn ui-btn-primary"><i class="fas fa-print"></i> Print</a>
